import { f as createLucideIcon, ab as useActor, a6 as useAuth, b as useAppContext, a as useNavigate, q as useSearch, r as reactExports, j as jsxRuntimeExports, o as motion, z as LoaderCircle, ac as createActor } from "./index-BOlz_vt-.js";
...
function EmailVerificationPage() {
  ...
  async function handleResend() {
    if (!actor || !(user == null ? void 0 : user.email)) return;
    setResending(true);
    setError("");
    try {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      disabled: resending || resendSent || isFetching || !(user == null ? void 0 : user.email),
