import { f as createLucideIcon, r as reactExports, y as usePWAInstall, j as jsxRuntimeExports, S as Smartphone, D as Download, G as useInternetIdentity, b as useAppContext, a6 as useRouterState, c as useOwnerGetPendingPaymentRequests, a7 as Shield, o as motion, L as Link } from "./index-Cjqrddtl.js";
import { c as cn, B as Button } from "./button-D6oP0EqP.js";
import { X } from "./x-Uov7pDbt.js";
import { U as Users } from "./users-DaTjNo1E.js";
import { S as Settings } from "./settings-C-Cy_zLI.js";
/**
...
const CircleUser = createLucideIcon("circle-user", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    ...
                    children: [
                      ...
                      to === "/pending-approvals" && pendingRequests && pendingRequests.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto bg-amber-500 text-white text-xs rounded-full px-1.5 py-0.5 min-w-[18px] text-center", children: pendingRequests.length })
                    ]
                  }
                )
              },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        to === "/pending-approvals" && pendingRequests && pendingRequests.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1.5 bg-amber-500 text-white text-[9px] font-bold rounded-full px-1 py-0.5 min-w-[14px] text-center leading-none", children: pendingRequests.length })
                      ]
                    }
                  ),
